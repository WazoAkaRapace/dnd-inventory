...
- `CharacterSpellsTab.tsx:131-149` calcule UN modificateur/UNE DD depuis la classe unique →
  par sort : `spellcastingAbility(classSource)` ; l'onglet affiche une DD par classe lancante
...
| **Caractéristiques — dérivées** | DD de sort par classe lancante (une ligne par classe), dés de vie « 3d10 + 2d8 » (mono) dans la tuile dé de vie, PV conseillés multiclassés. |
