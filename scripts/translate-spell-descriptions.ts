...
const _AIDEDD_SLUGS: string[] = [
  ...
  'amelioration-de-competences',
  'amis',
  'amitie-avec-les-animaux',
  'animation-d-objets',
  'animation-des-morts',
  'antidetection',
  'apaisement-des-emotions',
  'apparence-trompeuse',
  'appel-de-destrier',
  'appel-de-destrier-superieur',
  'appel-de-familier',
  'appel-de-la-foudre',
  'arme-elementaire',
  'arme-magique',
  ...
  'convocation-d-elementaire',
  'convocation-d-esprit-draconique',
  'convocation-de-bete',
  'convocation-de-celeste',
  'convocation-de-demon-majeur',
  'convocation-de-demons-mineurs',
  'convocation-de-fee',
  'convocation-de-fielon',
  'convocation-de-mort-vivant',
  'convocation-de-rejeton-d-ombre',
  'convocations-instantanees-de-drawmij',
  'coquille-antivie',
  'corde-enchantee',
  'cordon-de-fleches',
  ...
  'couteau-de-glace',
  'creation',
  'creation-d-homoncule',
  'creation-de-mort-vivant',
  'creation-de-nourriture-et-d-eau',
  'creation-ou-destruction-d-eau',
  'croissance-d-epines',
  'croissance-vegetale',
  'danse-irresistible-d-otto',
  'danse-macabre',
  'deblocage',
  'decharge-occulte',
  'dedale',
  ...
  'deluge-d-energie-negative',
  'demi-plan',
  'desintegration',
  'detection-de-la-magie',
  'detection-des-pensees',
  'detection-du-mal-et-du-bien',
  'detection-du-poison-et-des-maladies',
  'discours-captivant',
  'dispersion',
  ...
  'ennemis-a-foison',
  'entraves-de-givre',
  'epee-de-mordenkainen',
  'epine-mentale',
  'eruption-de-lames',
  'eruption-de-terre',
  'espieglerie-de-nathair',
  'esprit-faible',
  'esprit-guerisseur',
  'esprit-impenetrable',
  'esprits-gardiens',
  ...
  'fleches-enflammees',
  'fletrissement',
  'fletrissure-epouvantable-d-abi-dalzim',
  'flou',
  ...
  'lame-du-desastre',
  'lame-retentissante',
  'lance-d-arcon-psychique-de-raulothim',
  'lenteur',
  'levitation',
  'liane-avide',
  'libelle-aerien',
  ...
  'lien-avec-une-bete',
  'lien-de-protection',
  'lien-telepathique-de-rary',
  'localisation-d-animaux-ou-de-plantes',
  'localisation-d-objet',
  'localisation-de-creature',
  'lueur-d-espoir',
  'lueurs-feeriques',
  'lumiere',
  'lumiere-du-jour',
  ...
  'metal-brulant',
  'metamorphose',
  'metamorphose-de-groupe',
  'metamorphose-supreme',
  'minuscules-meteores-de-melf',
  'mirage',
  'mixture-caustique-de-tasha',
  'modification-d-apparence',
  'modification-de-memoire',
  'monture-fantome',
  'moquerie-cruelle',
  'mort-simulee',
  'mot-de-guerison',
  ...
  'mot-de-pouvoir-etourdissant',
  'mot-de-pouvoir-guerisseur',
  ...
  'sanctification',
  'sanctuaire',
  'sanctuaire-prive-de-mordenkainen',
  'saut',
  'saute-de-vent',
...
async function main() {
  ...
  const allSpells = spells
    ...
    .filter(({ spell }) => {
      ...
      return (
        ...
        ct.includes('minute') ||
        ct.includes('hour') ||
        d.includes('Instantaneous') ||
        d.includes('round') ||
        d.includes('minute') ||
        d.includes('hour') ||
        d.includes('Up to') ||
        d.includes('dispelled') ||
  ...
  console.log(
    `[translate-desc] batch: start=${batchStart}, size=${batchSize}, spells to process=${batch.length}`,
  );
  ...
  for (let i = 0; i < batch.length; i++) {
    ...
    if ((i + 1) % 10 === 0) {
      console.log(
        `[translate-desc] progress: ${i + 1}/${batch.length} (${updated} ok, ${failed} failed)`,
      );
