      ...
      return (
        <div className="flex min-h-screen items-center justify-center p-4">
          <div className="card w-full max-w-md p-6" role="alert">
            ...
            <h1 className="section-title mb-2">{title ?? 'Une erreur inattendue est survenue'}</h1>
            <p className="mb-4 text-sm text-ink-500">
              L'application a rencontré un problème et ne peut pas afficher cette page. Réessayez,
              ou rechargez la page si le problème persiste.
            </p>
            <details className="mb-4">
              <summary className="cursor-pointer text-sm text-ink-400">Détails techniques</summary>
